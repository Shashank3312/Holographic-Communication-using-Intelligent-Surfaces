...
Transmitter Node: Generates high-frequency signals (mmWave/THz) for holographic data encoding.
IRS Controller: Manages the phase shifts of the reflecting elements in real-time to focus beams toward the user.
Continuous Aperture LIS: Acts as a software-defined "mirror" to bypass obstacles and eliminate dead zones.
Holographic Rendering: The final stage where multi-view data is reconstructed into a 3D hologram at the receiver.
